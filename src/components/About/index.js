			...
			<div id="About" className='section'>
				<div className="about-description-container">
					...
					<p className="about-description-text">
							I'm Monty. I like to make cool things with electronics and code and sometimes put them in my Nerf guns. I'm currently interning at Apple as an electrical engineer on the Apple TV team. I also like to breakdance. 
					</p>
					<p className="about-description-text">I'm a first year electrical engineering student at Cal Poly SLO. I learned to code after my brother brought me to a hackathon and got involved in electronics when he gifted me an Arduino kit a few years later.</p>
				</div>
